      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-200">
            ...
            <th className="text-center pb-3 font-semibold text-gray-500 uppercase text-xs tracking-wider">Concluídos</th>
            <th className="text-center pb-3 font-semibold text-gray-500 uppercase text-xs tracking-wider">Em Atendimento</th>
